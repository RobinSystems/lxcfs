...
pkgdatadir = $(datadir)/lxcfs
pkgincludedir = $(includedir)/lxcfs
pkglibdir = $(libdir)/lxcfs
pkglibexecdir = $(libexecdir)/lxcfs
...
am_lxcfs_OBJECTS = lxcfs.$(OBJEXT) cgmanager.$(OBJEXT) \
	cpuset.$(OBJEXT)
lxcfs_OBJECTS = $(am_lxcfs_OBJECTS)
lxcfs_LDADD = $(LDADD)
AM_V_lt = $(am__v_lt_$(V))
...
am__v_CCLD_1 = 
SOURCES = $(lxcfs_SOURCES)
DIST_SOURCES = $(lxcfs_SOURCES)
...
CFLAGS = -g -O2
CGMANAGER_CFLAGS = -I/usr/local/include -I/usr/include/dbus-1.0 -I/usr/lib/x86_64-linux-gnu/dbus-1.0/include  
CGMANAGER_LIBS = -L/usr/local/lib -lcgmanager -lnih -lnih-dbus -ldbus-1  
CPP = gcc -E
CPPFLAGS = 
CYGPATH_W = echo
...
FUSE_LIBS = -pthread -L/usr/local/lib -lfuse  
GREP = /bin/grep
...
LDFLAGS = 
LIBOBJS = 
LIBS = -lnih -lcgmanager -lcgmanager 
LIBTOOL = $(SHELL) $(top_builddir)/libtool
LIPO = 
LN_S = ln -s
LTLIBOBJS = 
LXCCONFDIR = /usr/local/share/lxc/config/common.conf.d
LXCFSSHAREDIR = /usr/local/share/lxcfs
LXCFSTARGETDIR = /usr/local/var/lib/lxcfs
MAKEINFO = makeinfo
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
NIH_CFLAGS =  
...
STRIP = strip
VERSION = 0.9
abs_builddir = /home/raj/ws/lxcfs
abs_srcdir = /home/raj/ws/lxcfs
abs_top_builddir = /home/raj/ws/lxcfs
abs_top_srcdir = /home/raj/ws/lxcfs
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /home/raj/install-sh
...
AM_CFLAGS = -Wall -ggdb -D_GNU_SOURCE -DSBINDIR=\"$(SBINDIR)\" \
	$(DBUS_CFLAGS) $(NIH_CFLAGS) $(NIH_DBUS_CFLAGS) \
	$(CGMANAGER_CFLAGS) $(FUSE_CFLAGS)
...
lxcfs$(EXEEXT): $(lxcfs_OBJECTS) $(lxcfs_DEPENDENCIES) $(EXTRA_lxcfs_DEPENDENCIES) 
	@rm -f lxcfs$(EXEEXT)
	$(AM_V_CCLD)$(LINK) $(lxcfs_OBJECTS) $(lxcfs_LDADD) $(LIBS)
...
include ./$(DEPDIR)/cgmanager.Po
include ./$(DEPDIR)/cpuset.Po
include ./$(DEPDIR)/lxcfs.Po
